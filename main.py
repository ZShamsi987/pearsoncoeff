...
def home():
    ...
    # Button to calculate
    st.markdown("<h3 style='text-align: center; margin-top: 20px;'><button style='background-color: #FFA07A; color: white; padding: 10px 20px; border-radius: 5px;'>Calculate</button></h3>", unsafe_allow_html=True)
