...
def home():
    ...
    with col1:
        st.markdown("<p style='text-align: center; margin-bottom: 5px;'>Ticker 1</p>", unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("<p style='text-align: center; margin-bottom: 5px;'>Ticker 2</p>", unsafe_allow_html=True)
